...
# 训练集
train_data, train_features = load_data_and_features('../data/ct_dma/ct_dma_train_erp.pkl')
...
# 测试集
test_data, test_features = load_data_and_features('../data/ct_dma/ct_dma_test_剔除无效数据.pkl')
...
# 验证集
validation_data, validation_features = load_data_and_features('../data/ct_dma/ct_dma_valid_剔除无效数据.pkl')
